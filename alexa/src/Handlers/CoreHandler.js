  ...
  ,
    ...
    function(request, response) {
        ...
        var mailOptions = {
            ...
            to: ['john@reliefapplications.org'], // list of receivers
            bcc: ['axel.reliefapps@gmail.com'],
            subject: 'Bangladesh 2017 Report', // Subject line
            html: 'Hi John, <br/>' +
                'Here is the 2017 report for Bangladesh: ' +
